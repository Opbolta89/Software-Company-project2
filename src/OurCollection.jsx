...
const categories = [
  ...
  },
  {
    id: 'anklets',
    title: 'ANKLETS',
    image: 'https://images.unsplash.com/photo-1602173574767-37ac01994b2a?q=80&w=400',
    ...
    <div className="bg-gradient-to-b from-white via-amber-50/30 to-white py-20 px-4 md:px-10">
          ...
          >
            <div className="relative aspect-[3/4] overflow-hidden bg-gray-900">
              <img
                src={item.image}
                alt={item.title}
                className="w-full h-full object-cover transition-all duration-700 ease-out group-hover:scale-110 group-hover:rotate-1 filter brightness-90 group-hover:brightness-75"
              />
      ...
      <div className="text-center mt-16">
        <button
          ...
          className="group relative inline-flex items-center gap-3 px-10 py-4 bg-black text-white overflow-hidden transition-all duration-500 hover:bg-amber-500"
        >
